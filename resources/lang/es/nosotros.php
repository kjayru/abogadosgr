...
return [
    ...
    "texto3" =>"Especialistas que inspiran confianza brindando servicios
    jurídicos en las áreas de derecho mercantil, corporativo, bursátil,
    inmobiliario, laboral y administrativo.",
    "texto4"=>" Somos un despacho fundado en el año de 1995. Ahora, con más de 25 años de experiencia,
    ...
    "texto5"=>" A lo largo de nuestra amplia trayectoria, hemos adquirido valiosa experiencia brindando servicios de asesoría,
    ...
    "texto6"=>"<span>Nuestros</span><br>  Abogados",
    "texto7" => "Los profesionistas que laboran con nosotros cuentan con las capacidades necesarias para comprender
    los asuntos de nuestros clientes, asesorándolos correctamente.",
    "texto8"=>"Esto se ha logrado a través de una atención personalizada, siendo accesibles y manteniéndolos informados
    ...
    "texto9"=>"Visión",
    "texto10"=>"Para el futuro, seguiremos proporcionando los servicios de la más alta calidad profesional,
    siempre actuando dentro del marco de la legalidad.",
    "texto11"=>" Deseamos atraer nuevos clientes, los cuales puedan recomendarnos posteriormente y tengan
    confianza en que este despacho les proveerá de una acertada asistencia legal.",
    "texto12"=>"Asesoría en la<br> República Mexicana",
    "texto13"=>"En nuestro país, hemos establecido una amplia red de corresponsales que cuentan con toda nuestra confianza,
    los cuales se encuentran ubicados en las principales ciudades: Ciudad de México, Guadalajara, Querétaro, entre otras.",
    "texto14"=>" Nuestros corresponsales son expertos que conocemos a profundidad y que cuentan con el más alto
    prestigio personal y profesional.",
    "texto15"=>"Alcance <br>Internacional",
    "texto16"=>" Las fronteras nunca han sido un límite. Aún y cuando las oficinas de García Corral y Rodríguez se encuentran
    ubicadas físicamente en la ciudad de Monterrey, Nuevo León, México, contamos con acceso inmediato a asesoría
     jurídica en diversos países, especialmente en los Estados Unidos de América, mediante corresponsales que han
      ...
      "texto17"=>"En adición a sus conocimientos legales, estas firmas de abogados en el extranjero cuentan con la experiencia
